				...
				<div class="col-lg-4 col-md-12 col-sm-12 align-self-center" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
					<div class="features-small-item">
						<div class="Consulta">
							...
							<br>
							<p>Esta API incluye un entorno Sandbox para probar sus aplicaciones antes de acceder a datos en vivo.</p>
							<p>Para que el entorno sandbox funcione, debe ingresar una <strong>Clave CURP</strong> Real, prueba con la tuya, y asi realiza las pruebas necesarias.</p>
							<p>A continuación te adjuntamos ligas que te pueden servir para que configures tu entorno <strong>API_REGISTRO</strong>:</p>
							<br>
							<h2 class="titulos"><strong>RELATED RESOURCES</strong></h2>
							<br>
							<a Target="_blank" href="https://learning.postman.com/docs/getting-started/introduction/">Postman tutorial</a>
							<br>
							<a Target="_blank" href="https://hackernoon.com/es/construir-una-calculadora-de-prestamos-javascript-con-html-y-css">Calculadora de préstamos</a>
							<br>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<table class="table table-responsive justify">
							<tr>
								...
								<td><strong>DATOS PARA MODO SANDBOX</strong></td>
							</tr>
							<tr>
								<td>PRIVATE_KEY</td>
								<td style="text-align: justify;">ef235aacf90d9f4aadd8c92e4b2562e1d9eb97f0</td>
							</tr>
							<tr>
								<td>nombre_de_usuario</td>
								<td style="text-align: justify;">Api_KASU_Sandbox</td>
							</tr>
							<tr>
								<td>curp_en_uso</td>
								<td style="text-align: justify;">CAMC880526HMCBNR04</td>
							</tr>
							<tr>
								<td>curp_en_uso</td>
								<td style="text-align: justify;">CAPC200504HMCBXRA2</td>
							</tr>
							<tr>
								<td>curp_en_uso</td>
								<td style="text-align: justify;">REAE060617MMCYLVA4</td>
							</tr>
						</table>
					</div>
				</div>
	...
	<section class="section padding-top-70" id="">
		<div class="container">
			<div class="Consulta">
					...
					<br>
					<p>Esta peticion nos permite saber el costo de el producto que seleccione el cliente, recuerda que debes usar la <strong>CLAVE CURP</strong> que fue usada para generar el Token de Acceso, retorna el costo del producto y te permite calcular las comisiones, pagos y maximos tiempos de credito</p>
					<br>
			</div>
			<div class="row">
				<div class="col-lg-6 col-md-12 col-sm-12 align-self-center" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
