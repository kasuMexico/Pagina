...
<!-- Header -->
<header <?php lordcros_header_classes( 'header-layout-9' ); ?>>
	<div class="header-wrapper <?php echo esc_attr( $container_class ); ?>">
		<div class="header-wrap-inner">
			...
			<div class="header-right-part">
				<?php echo lordcros_room_header_search_form(false); // Check Room Form ?>
			</div>
		</div>
	</div>
</header>
...
<?php if ( $sticky_header_setting ) : ?>
	<div <?php lordcros_sticky_header_classes( 'header-layout-9' ); ?>>
		<div class="header-wrapper <?php echo esc_attr( $container_class ); ?>">
			<div class="main-header-wrap">
				<?php
