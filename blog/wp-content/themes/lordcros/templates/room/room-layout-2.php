...
?>
<div id="room-<?php echo esc_attr( $room_id ); ?>" class="single-room-page-wrapper room-slider-header-layout">
	<div class="room-gallery-slider-wrapper">
		<div class="room-image-gallery">
			<div class="room-slider-placeholder">
				<?php echo wp_get_attachment_image( $room_images[0], 'lordcros-room-full-screen-gallery' ); ?>
			</div>
				...
				<figure class="owl-carousel featured-image-slider">
					<?php foreach ( $room_images as $image ) : ?>
						<div id="room-image-<?php echo esc_attr( $image ); ?>" class="gallery-item">
							<?php echo wp_get_attachment_image( $image, 'lordcros-room-full-screen-gallery' ); ?>
						</div>
					<?php endforeach; ?>
				</figure>
			<?php endif; ?>
		</div>
		<div class="room-title-section container">
			<div class="room-title-wrapper">
				<h1 class="entry-title"><?php the_title(); ?></h1>
			</div>
			<div class="price-section">
				<span class="price-val"><?php echo esc_html( lordcros_price( $price_per_night ) ); ?></span>/<?php echo esc_html__( 'night', 'lordcros' ); ?>
			</div>
		</div>
	</div>
