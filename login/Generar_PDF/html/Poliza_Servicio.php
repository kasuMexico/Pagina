<?php
  //Selector de Datos para mostrar en la poliza
  if(empty($name)){
    $DatosSolicitante = $curp;
  }else{
    $DatosSolicitante = htmlentities($name, ENT_QUOTES, "UTF-8");
  }
  echo '
  <html lang="es">
		<head>
					  ...
					  <img src="https://kasu.com.mx/assets/poliza/img2/transp.jpg" class="header">
						...
						<div class="w-tab">
						    ...
						    <table class="date">
						        ...
						        <tr>
						            <td>ACTA CONSTITUTIVA:</td>
						            <td>38,160 volumen ordinario DCLXXX(SETESCIENTOS OCHENTA)</td>
						        </tr>
						        <tr>
						            <td>PODER:</td>
						            <td>40,853 volumen ordinario 713 (SETESCIENTOS TRECE)</td>
						        </tr>
						     </table>
						</div>
						<br>
						...
						<table class="ba date">
								<tr>
										...
										<td class="mb ct">'.$DatosSolicitante.'</td>
								</tr>
								<tr>
										<td class="bl">Tel&eacute;fono:</td>
										<td class="bl ct">'.$phone.'</td>
										<td class="bl">e-mail</td>
										<td class="bl ct">'.$email.'</td>
								</tr>
								<tr>
										<td class="mb"  colspan="3"> Direccion:</td>
										<td class="mb ct"> '.$direccion.'</td>
								</tr>
						</table>
						<br>
						<img src="https://kasu.com.mx/assets/poliza/img2/LINE7.jpg" class="h-line">
						...
						<table class="ser">
									...
									<tr>
											<td class="mw">'.$productoA.'</td>
											<td class="mda">'.$Costo.'</td>
									</tr>
									<tr>
											<td class="mw">Identificador de Poliza </td>
											<td class="md">'.$IdFIrma.'</td>
									</tr>
									<tr>
											<td class="mw">Tipo de servicio</td>
										  <td class="md">'.$TipoServicio.'</td>
									</tr>
						</table>
						<br><br>
						<img src="https://kasu.com.mx/assets/poliza/img2/LINE7.jpg" class="h-line">
