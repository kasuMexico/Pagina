...
<head>
  ...
  <link rel="stylesheet" href="https://kasu.com.mx/assets/css/poliza.css?v=20251107">
</head>
<body>
...
<div class="container">
  ...
  <table class="ba date">
    <tr><td class="mb" colspan="3"> Solicitante:</td><td class="mb ct"><?= $DatosSolicitante ?></td></tr>
    <tr><td class="bl">Tel&eacute;fono:</td><td class="bl ct"><?= htmlentities((string)$phone, ENT_QUOTES, 'UTF-8') ?></td><td class="bl">e-mail</td><td class="bl ct"><?= htmlentities((string)$email, ENT_QUOTES, 'UTF-8') ?></td></tr>
    <tr><td class="mb" colspan="3"> Direccion:</td><td class="mb ct"><?= htmlentities((string)$direccion, ENT_QUOTES, 'UTF-8') ?></td></tr>
  </table>
  ...
  <table class="ser">
    <tr><td class="mw">Servico Contratado</td><td class="mw">Descripcion</td></tr>
    <tr><td class="mw"><?= $productoA ?></td><td class="mda"><?= $Costo ?></td></tr>
    <tr><td class="mw">Identificador de Poliza </td><td class="md"><?= htmlentities((string)$IdFIrma, ENT_QUOTES, 'UTF-8') ?></td></tr>
    <tr><td class="mw">Tipo de servicio</td><td class="md"><?= htmlentities((string)$TipoServicio, ENT_QUOTES, 'UTF-8') ?></td></tr>
  </table>
        ...
        <ul class="ul-adver">
          <?php if ($Producto == "Universidad"): ?>
            ...
            <ul>
              ...
              <li>&nbsp;&nbsp;Cuando el servicio exceda los fondos depositados en el f/0009, depositados en la cuenta de el cliente <?= empty($name) ? htmlentities((string)$curp, ENT_QUOTES, 'UTF-8') : htmlentities((string)$name, ENT_QUOTES, 'UTF-8') ?></li>
  ...
  <img src="https://kasu.com.mx/assets/poliza/img2/firma.jpg" class="img-f2" alt="">
  ...
  <?php if ($Producto == "Universidad"): ?>
    <!-- ======= BLOQUE UNIVERSIDAD (contenido intacto) ======= -->
    <div class="container">
      ...
      <p class="hd-text"><strong>B)</strong> Las aportaciones de cada <strong>CLIENTE</strong> al mencionado <strong>FIDEICOMISO F/0009</strong>
      ...
      <p class="hd-text">C) Que el contrato <strong>FIDEICOMISO F/0009</strong> se especifica que <strong>KASU SERVICIOS A FUTURO, S.A. DE C.V.</strong>
        Ser&aacute; el &uacute;nico distribuidor y comercializador con autorizaciones para realizar los contratos de
      ...
      <h2 class="hd-sub"><strong>C  L Á U  S  U  L  A  S</strong></h2>
      ...
      <p class="hd-text"><strong>LA INVERSION UNIVERSITARIA</strong> cubrir&aacute; los siguientes servicios:</p>
      <ul class="hd-entrada">
        ...
        <li class="hd-text"><strong>PAGO DE CUOTAS ORDINARIAS:</strong> se le denominan como cuotas ordinarias a todos aquellos pagos correspondientes
        ...
        <li class="hd-text"><strong>PAGO DE ACCCESORIOS A LAS CUOTAS ORDINARIAS:</strong> se le denominan como accesorios cuotas ordinarias a todos aquellos pagos adherentes
        ...
        <li class="hd-text"><strong>EL PAGO DE DERECHOS DE EXAMEN:</strong> se le denominan como derechos de examen a todos aquellos pagos correspondientes
    ...
    <div class="container">
      ...
      <p class="hd-text">
        ...
        lo firman en <strong><?= htmlentities((string)$direccion, ENT_QUOTES, 'UTF-8') . " el " . htmlentities((string)substr((string)$FechaR, 0, -16), ENT_QUOTES, 'UTF-8') ?></strong>.
      </p>
  ...
  <?php else: ?>
    ...
    <div class="container">
      ...
      <p class="hd-text">
        ...
        consentimiento que pudiera invalidar, en consecuencia, lo firman en <strong><?= htmlentities((string)$direccion, ENT_QUOTES, 'UTF-8') . " el " . htmlentities((string)substr((string)$FechaR, 0, -16), ENT_QUOTES, 'UTF-8') ?></strong>.
      </p>
      ...
      <td class="hc-serf">
        <?php if ($Producto == "Universidad"): ?>
          <div>
            ...
            <div class="hd-vs">
              <ul><li class="hc-vires">Pago de colegiaturas ( 10 semestres ).</li></ul>
              <ul><li class="hc-vires">Inscripciones y reinscripciones.</li></ul>
              <ul><li class="hc-vires">Periodos ordinarios.</li></ul>
            </div>
            ...
            <img src="https://kasu.com.mx/assets/poliza/img2/pagin.jpg" class="hc-url" alt="">
          </div>
        <?php else: ?>
          <div>
            <h1 class="hc-sert"> PREGUNTAS FRECUENTES</h1>
        ...
        <div>
          ...
          <?php if ($Producto == "Universidad"): ?>
            ...
            <p class="hc-ques-tex">Mediante una estructura de fideicomiso KASU te permite pagar la
              ...
              privada, recuerda que preveenir es mejor.</p>
          <?php else: ?>
