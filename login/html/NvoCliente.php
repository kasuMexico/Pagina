...
<div class="modal-body">
  <form action="https://kasu.com.mx/eia/Registrar_Venta.php" method="post" accept-charset="utf-8" autocomplete="off">
    ...
    <div class="mb-2">
      <input class="form-control mb-2" type="text" name="Codigo_Postal" placeholder="Código Postal" inputmode="numeric" pattern="^\d{5}$">
      <div class="row mb-2">
        <div class="col-6"><input class="form-control" type="text" name="Calle" placeholder="Nombre de la Calle"></div>
        <div class="col-6"><input class="form-control" type="text" name="Numero" placeholder="Número"></div>
      </div>
      ...
      <div class="row mb-2">
        ...
        <div class="col-6"><input class="form-control" type="text" name="Estado" placeholder="Estado"></div>
      </div>
