						...
						<? 
							...
							// devuelve el descuento para este cupón
								$Desc = $basicas->BuscarCampos(
									$mysqli,"Descuento","PostSociales","Id",$_SESSION['tarjeta']);
							} else {
							...
							//IMPRIMIOS LA IMAGEN
								echo '
									...
									<br>
									<a href="registro.php?pro='.$dat.'" class="main-button-slider-pol"><strong>Comprar - $'.number_format($Desc, 2).'</strong></a>
									<br>
								';
