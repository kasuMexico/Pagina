...
<body>
  ...
  <section class="section padding-bottom-100" id="terminos" aria-label="Términos y Condiciones de KASU">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-6 align-self-center term">
          <h1 style="color:#e83e8c">Términos y Condiciones</h1>

          <div class="term" id="uso-servicios">
          ...
          <div class="term" id="su-contenido">
          ...
          <div class="term" id="responsabilidad">
          ...
          <div class="term" id="acerca-de-estas-condiciones">
